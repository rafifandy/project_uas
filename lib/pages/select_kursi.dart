    ...
    return Align(
        ...
        child: FloatingActionButton(
            ...
            child: Icon(
              Icons.arrow_forward,
              color:
                  selectedSeats.length > 0 ? Colors.white : Color(0xFFBEBEBE),
            ),
            onPressed: () {
              if (selectedSeats.length > 0) {
                if (selectedSeats.length == 1) {
                  ...
                  tiket = storePemesanan(Preferensi().getMoviesID.toString(),
                      selectedSeats[0], Preferensi().getEmail);
                }
              }
            }));
  }
        ...
        builder: (context, snapshot) {
          if (snapshot.hasData) {
            ...
            WidgetsBinding.instance!.addPostFrameCallback((timeStamp) {
              Navigator.push(
                  context, MaterialPageRoute(builder: (context) => Tiket()));
            });
